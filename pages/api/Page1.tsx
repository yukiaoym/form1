...
import { Input, Pulldown, Radio, Checkbox, MultiText, SupportArrays, AdminArrays } from './Elements';
...
export default function Page1() {
    ...
    return (
        <>
            ...
            <AdminArrays label='管理者メールアドレス' sublabel='管理者' register={register} required={false} errors={errors} />
