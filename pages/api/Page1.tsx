...
export default function Page1() {
    ...
    return (
        <>
            ...
            <Section>
                <Input label='依頼事項' register={register} required={true} errors={errors} sub={false}/>
            </Section>
            <Section>
            ...
            <Section>
                <Select label='ご契約サービス' register={register} list={service_list} disabled={false} sub={false}/>
            </Section>
            <Section>
                <Input 
                    label='ご契約アカウント数'
            ...
            <Section>
                <Radio label='O365・G_suite切替' register={register} list={['切替前', '切替後']} sub={false} />
            </Section>
            <Section>
                <SectionTitle label='MXレコード' required={false} sub={false} />
                <Input label='切替前のMXレコード' register={register} required={false} errors={errors} sub={true} /> 
                <Input label='切替後のMXレコード' register={register} required={false} errors={errors} sub={true} />             
            </Section>
            <Section>
